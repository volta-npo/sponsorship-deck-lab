  ...
  "criteria": [
    {
      ...
      "prompt": "Implement and verify sponsor persona cards with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify impact proof sections with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "package-builder",
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify package builder with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify objection handling notes with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "evidence-quality",
